...
## 선행 요건 확인
Chzzk Clip Manager의 모든 기능을 활용하려면, Chzzk Clip Downloader가 올바르게 설정되어 있어야 하며, Chzzk Clip Downloader를 실행하려면 FFmpeg의 공식 메이저 버전(버전 7.0 이상)이 올바르게 설정되어 있어야 합니다. Chzzk Clip Manager가 처음 실행될 때 이와 같은 선행 요건을 모두 확인하는 과정을 거치며, 이를 만족하지 못할 경우 다음 그림과 같은 대화 상자가 표시됩니다.
...
`설정...` 버튼을 누르면 Chzzk Clip Downloader의 위치를 지정할 수 있으며, `다운로드` 버튼을 눌러 FFmpeg을 설치할 수 있습니다.
...
## 클립 추가
다운로드할 클립을 추가하려면 ☰ 아이콘을 클릭한 후 `클립 추가` 항목을 선택하면 클립 추가 대화 상자가 열립니다. 추가할 클립 UID 또는 클립 URL을 입력하고 `확인` 버튼을 누릅니다.
...
## 클립 삭제
클립을 삭제하려면, 목록에서 삭제할 클립을 선택한 다음 ☰ 아이콘을 클릭한 후 `클립 삭제` 항목을 선택합니다. 클립 삭제 여부를 확인하는 대화 상자에서 `OK` 버튼을 누르면 클립이 삭제됩니다.
...
## 클립 등록 정보 확인
클립의 등록 정보를 확인하려면, 목록에서 등록 정보를 확인할 클립을 선택한 다음 ☰ 아이콘을 클릭한 후 `등록 정보...` 항목을 선택합니다.
...
목록에 클립이 하나 이상 존재하는 상태에서 ☰ 아이콘을 클릭한 후 `클립 목록 저장...` 항목을 선택하면, 파일을 저장할 디렉터리와 이름을 변경할 수 있는 대화 상자가 열립니다.

## 클립 목록 불러오기
매번 클립을 추가하는 대신 저장했던 클립 목록을 불러와서 추가할 수 있습니다.

☰ 아이콘을 클릭한 후 `클립 목록 불러오기...` 항목을 선택하면, 클립 목록 파일을 선택할 수 있는 대화 상자가 열립니다.

불러 온 목록에 있는 클립이 아미 현재 목록에 있더라도 자동으로 인식되어 처리됩니다.

## 클립 목록 가져오기
바이너리 형식의 목록 파일 대신 텍스트 형식으로 저장된 클립 UID 목록을 가져올 수 있습니다.
...
## 클립 목록 내보내기
클립 목록을 직접 외부에서 편집하거나 전달하기 위해 텍스트 형식으로 내보낼 수 있습니다.
...
## 화면 색상 테마 모드 전환하기
Chzzk Clip Manager는 기본적으로 시스템의 앱 색상 테마 설정에 따라 자동으로 화면 색상이 변경됩니다.
...
## 저장 디렉터리 열기
다운로드한 클립이 저장된 디렉터리를 열려면, ☰ 아이콘을 클릭한 후 `도구` 항목에서 `저장 디렉터리 열기` 항목을 선택합니다.
...
## 다운로드 도구 설정 보기
Chzzk Clip Downloader의 설정을 보려면, ☰ 아이콘을 클릭한 후 `도구` 항목에서 `설정 보기...` 항목을 선택합니다.

<div style='text-align: center'>
<img src='../../img/screenshots/cman_ko-KR/cman_configuration.png' />
<p><i>(이 이미지는 최신 정보와 다를 수 있습니다.)</i></p>
</div>
...
- **최신 버전 확인 주기** - Chzzk Clip Manager를 시작할 때 최신 버전을 확인하는 주기를 설정합니다. `최신 버전 확인` 버튼을 누르면 즉시 최신 버전을 확인할 수 있습니다.
...
- **시스템 성능** - Chzzk Clip Manager가 실행 중인 시스템의 성능을 지정합니다. 클립을 다운로드할 때 시간 초과로 인한 오류가 발생한다면, 이 설정을 한 단계 아래로 낮추는 것을 고려해 볼 수 있습니다.
...
<div style='text-align: center'>
<img src='../../img/screenshots/cman_ko-KR/cman_settings_tools.png' />
<p><i>(이 이미지는 최신 정보와 다를 수 있습니다.)</i></p>
</div>
...
<div style='text-align: center'>
<img src='../../img/screenshots/cman_ko-KR/cman_settings_login.png' />
<p><i>(이 이미지는 최신 정보와 다를 수 있습니다.)</i></p>
</div>
