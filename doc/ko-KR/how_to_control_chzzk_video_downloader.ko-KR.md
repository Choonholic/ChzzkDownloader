# Chzzk Video Downloader 외부 제어 방법 (JSON-RPC 사용)
...
* **포트 번호** - 기본 포트 번호는 `63000`입니다. `--rpcport` 옵션을 사용해 변경할 수 있습니다. (사용 가능 범위: `49152`~`65300`)
* **RPC ID** - 기본 ID는 `30`입니다. `--rpcid` 옵션을 사용해 변경할 수 있습니다.
