# Windows 버전 Streamlink 설치하기

만약 여러분이 파이써니스타라고 불리는 Python 개발자라면, 다음 단계를 실행하는 대신 직접 `pip`를 통해 `streamlink`를 설치할 수 있습니다.

1. [streamlink-8.1.2-1-py314-x86_64.exe](https://github.com/streamlink/windows-builds/releases/download/8.1.2-1/streamlink-8.1.2-1-py314-x86_64.exe)를 다운로드합니다.
