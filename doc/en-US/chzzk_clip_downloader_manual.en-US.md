...
--rpcport [PORT]        Set JSON-RPC server port (default: 64000, 49152-65300)
--rpcid [ID]            Set JSON-RPC server ID (default: 50)
```
...
ChzzkClipDownloader clip_uid or url --threshold 1GB
ChzzkClipDownloader clip_uid or url --threshold 100M
ChzzkClipDownloader clip_uid or url --threshold 800MiB
```
